...
<div id="api">
    ...
    Adding a <tt>jsonp</tt> parameter will insert the JSON data as an argument to a function named by the <tt>jsonp</tt> parameter. It can then be run by loading it in a &lt;script&gt; tag.
