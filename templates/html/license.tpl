    ...
    <tr>
        ...
        <td>
            ...
            <div>
                ...
                <input name="license" type="radio" value="CC BY-SA" id="lsa" title="Attribution-ShareAlike" {{#CC_BY_SA}}checked="checked"{{/CC_BY_SA}} /> <label for="lsa">Attribution-ShareAlike <a href="http://creativecommons.org/licenses/by-sa/3.0">(BY-SA)</a></label>
